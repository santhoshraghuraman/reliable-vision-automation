...
export function parseCampaignRecord(record: Record<string, unknown>): Campaign {
  ...
  return {
    ...
    delivered_count: meta.delivered_count || (record.delivered_count as number) || 0,
    failed_count: meta.failed_count || (record.failed_count as number) || 0,
    read_count: meta.read_count || (record.read_count as number) || 0,
    replied_count: meta.replied_count || (record.replied_count as number) || 0,
